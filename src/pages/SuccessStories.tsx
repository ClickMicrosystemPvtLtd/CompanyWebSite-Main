    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden px-4 pb-16 pt-28 sm:px-6 md:px-8 md:pb-20 md:pt-32">
        ...
        <div className="container-custom relative z-10">
          <AnimatedSection className="max-w-3xl">
            <span className="text-accent font-display text-xs font-medium tracking-wider uppercase text-hero-sub sm:text-sm">Success Stories</span>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="mb-10 flex flex-wrap justify-center gap-3 md:mb-12">
          ...
          <AnimatedSection>
            <div className="relative overflow-hidden rounded-2xl p-6 text-center sm:p-8 md:p-16">
              ...
              <div className="relative z-10">
                <h2 className="mb-4 font-display text-2xl font-bold text-white text-hero-shadow sm:text-3xl md:text-4xl">
